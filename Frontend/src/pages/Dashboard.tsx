...
import AIDailyInsight from "../components/ai/AIDailyInsight"; // ← NEW
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col overflow-y-auto mt-8">
      ...
      <div className="px-4 space-y-4 mb-20 sm:mb-20 min-[623px]:mb-42 md:mb-24 lg:mb-14 lg:grid lg:grid-cols-2 lg:gap-4 lg:px-20">

        {/* ─── AI DAILY INSIGHT (NEW) ─── */}
        ...
        {user && (
          <Card className="bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-slate-600 dark:text-slate-400 text-sm">Your Goal</p>
